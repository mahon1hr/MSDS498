...
business=pd.read_csv('C:/Users/cscanlon/Desktop/SQL/NW/12-CAPSTONE/Project/Datasets/yelp_business_use.csv')
...
reviews_df.shape #(323943, 9)

#Count distinct business ids
len(reviews_df.business_id.unique().tolist()) #3584
...
demographics_df.shape #(41, 122) - matched 41 out of 48 zip codes
# missing: could either remove or use averages
...
final.shape #(3584, 209) #(3584, 209) looks good
